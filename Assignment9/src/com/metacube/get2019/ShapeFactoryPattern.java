		...
		try {
			do {
				...
				case 4:
					...
					System.out.println("---------------------------------");
					System.out.println("ID\t\tSHAPETYPE\tPERIMETER");
					System.out.println("--------------------------------");
					for (int i = 0; i < tempList.size(); i++) {
						System.out.println(tempList.get(i).getId()+"\t\t"+tempList.get(i).getShapeType()+"\t\t"+tempList.get(i).getPerimeter());
					}
					System.out.println("--------------------------------");
					break;
				case 5:
					...
					System.out.println("---------------------------------");
					System.out.println("ID\t\tSHAPETYPE\tAREA");
					System.out.println("--------------------------------");
					for (int i = 0; i < tempList.size(); i++) {
						System.out.println(tempList.get(i).getId()+"\t\t"+tempList.get(i).getShapeType()+"\t\t"+tempList.get(i).getArea());
					}
					System.out.println("--------------------------------");
					break;
				case 6:
